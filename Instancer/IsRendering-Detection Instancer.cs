...
namespace VRLabs.IsRenderingDetection
{
	public class IsRenderingDetection : ScriptableObject
	{
		public const string packageName = "IsRendering-Detection";
		...
		public static void FancyPackage()
		{
			...
			var editor = ScriptableObject.CreateInstance<IsRenderingDetection>();
